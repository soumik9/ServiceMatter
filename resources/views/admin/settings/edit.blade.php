                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        @if(!empty($setting->website_logo_dark))
                                                                            <img src="{{ $setting->website_logo_dark }}" alt="..." id="website_logo_dark_output" class="img-thumbnail mb-3"  onerror="this.src='{{ asset('assets/admin/img/logo-bold.png') }}';">
                                                                        @else
                                                                            <img src="" alt="..." id="website_logo_dark_output" class="img-thumbnail mb-3" onerror="this.src='{{ asset('assets/admin/img/logo-bold.png') }}';">
                                                                        @endif
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        @if(!empty($setting->website_logo_light))
                                                                            <img src="{{ $setting->website_logo_light }}" alt="..." id="website_logo_light_output" class="img-thumbnail rounded mb-3"  onerror="this.src='{{ asset('assets/admin/img/logo-bold.png') }}';" style="background-color: #ccc;">
                                                                        @else
                                                                            <img src="" alt="..." id="website_logo_light_output" class="img-thumbnail rounded mb-3" onerror="this.src='{{ asset('assets/admin/img/logo-bold.png') }}';" style="background-color: #ccc;">
                                                                        @endif
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        @if(!empty($setting->website_logo_small))
                                                                            <img src="{{ $setting->website_logo_small }}" alt="..." id="website_logo_output" class="img-thumbnail rounded mb-3"  onerror="this.src='{{ asset('assets/admin/img/favicon.png') }}';" style="height: 60px;">
                                                                        @else
                                                                            <img src="" alt="..." id="website_logo_small_output" class="img-thumbnail rounded mb-3" onerror="this.src='{{ asset('assets/admin/img/favicon.png') }}';" style="height: 60px;">
                                                                        @endif
