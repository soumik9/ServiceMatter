                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="datatable table table-hover table-center mb-0 custom-table">
                            <thead>
                                <tr>
                                    <th>{{ __('default.table.hire_no') }}</th>
                            ...
                            <tbody>
                                @foreach ($hires as $hire)
                                    <tr>
                                        ...
                                        <td>
                                            @if(auth()->user()->can('hrie-edit') || auth()->user()->can('hire-view') || auth()->user()->can('hire-delete'))
                                                @can('hire-view')
                                                    <a href="{{ route('admin.hires.view', $hire->id) }}" class="custom-edit-btn mr-1">
                                                        <i class="far fa-eye"></i>
                                                    </a> 
                                                @endcan

                                                @can('hire-edit')
                                                    <a href="{{ route('admin.hires.edit', $hire->id) }}" class="custom-edit-btn mr-1">
                                                        <i class="far fa-edit"></i>
                                                    </a> 
                                                @endcan

                                                @can('hire-delete')
                                                    <a href="{{ route('admin.hires.destroy', $hire->id) }}" class="custom-delete-btn delete-hire">
