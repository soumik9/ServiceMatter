                ...
                <div class="col-sm-12">
                    ...
                    <div class="card breadcrumb-card">
                        <div class="row justify-content-between align-content-between" style="height: 100%;">
                            <div class="col-md-6">
                                <h3 class="page-name">{{ __('cms.edit.title') }}</h3>
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active-breadcrumb">
                                        <a href="{{ route('cms.edit', $cms->id) }}">{{ __('cms.edit.title') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title" value="{{ $cms->title }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" disabled value="{{ $cms->slug }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cms_category_id" id="cms_category_id" class="form-control select2">
                                        @foreach ($cmscategories as $cmscategory)
                                            ...
                                            <option value="{{ $cmscategory->id }}" @if($cms->cms_category_id == $cmscategory->id) selected  @endif>{{ $cmscategory->name }}</option>
                                            {{-- @else
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="20">{{ $cms->description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="select2">
                                        ...
                                        <option value="0" @if($cms->status == 0) selected  @endif>Inactive</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_title" id="meta_title" value="{{ $cms->meta_title }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="meta_description" id="meta_description" class="form-control" rows="10">{{ $cms->meta_description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_keywords" id="meta_keywords" value="{{ $cms->meta_keywords }}" required>
