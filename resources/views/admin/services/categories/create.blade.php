...
@section('title')
    {{ __('servicecategory.create.title') }}
@endsection
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card breadcrumb-card">
                        <div class="row justify-content-between align-content-between" style="height: 100%;">
                            <div class="col-md-6">
                                <h3 class="page-title">{{ __('servicecategory.create.title') }}</h3>
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active-breadcrumb">
                                        <a href="{{ route('servicecategories.create') }}">{{ __('servicecategory.create.title') }}</a>
                                        </li>
                                </ul>
                            </div>
                            <div class="col-md-3">
