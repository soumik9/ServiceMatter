...
@section('title') {{ __('permission.edit.title') }} @endsection
                    ...
                    <div class="card breadcrumb-card">
                        <div class="row justify-content-between align-content-between" style="height: 100%;">
                            <div class="col-md-6">
                                ...
                                <h3 class="page-title">{{ __('permission.edit.title') }}</h3>
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active-breadcrumb">
                                        <a href="{{ route('permissions.edit', $permission->id) }}">{{ __('permission.edit.title') }}</a>
                                    </li>
                                </ul>
